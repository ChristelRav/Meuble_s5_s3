...
/*---------------------------------------------------------SETTERS---------------------------------------------------------*/   
    ...
    public void setQuantiteUtilisee(double quantiteUtilisee) throws Exception {
        if(quantiteUtilisee < 0){
            this.quantiteUtilisee = quantiteUtilisee;
        }else {
            throw new UnitaireE("La quantite  est invalide");
        }
    }
/*--------------------------------------------------CONSTRUCTEURS---------------------------------------------------------*/  
    public ConfectionMeuble() {}
    public ConfectionMeuble(int idMeuble, int idMateriel, double quantiteUtilisee) throws Exception {
        this.setIdMeuble(idMeuble);
        this.setIdMateriel(idMateriel);
        this.setQuantiteUtilisee(quantiteUtilisee);
    }
    public ConfectionMeuble(int idConfectionMeuble, int idMeuble, int idMateriel, double quantiteUtilisee) throws Exception {
