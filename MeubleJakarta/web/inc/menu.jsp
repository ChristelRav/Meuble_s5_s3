        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Meuble</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Confection</span>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Layouts">Insertion Défaut</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="${pageContext.request.contextPath}/DefaultServlet?a=4" class="menu-link">
                    <div data-i18n="Without navbar">Fonctionnalite meuble</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <!-- Components -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Vente</span></li>
            <!-- Cards -->
            
            <!-- Forms & Tables -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">En Stock</span></li>
            <!-- Forms -->
