   ...
   <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/SelectServlet" method="get" >
                             <input type="hidden" value="4" class="form-control" id="exampleInputPassword1" name="a">
                              <input type="hidden" value="<% out.print(id); %>" class="form-control" id="exampleInputPassword1" name="categorie">
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Prix max</label>
                          <div class="col-sm-10">
                            <input type="number" name="max" class="form-control" id="basic-default-name" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Prix min</label>
                            <div class="col-sm-10">
                            <input type="number" name="min" class="form-control" id="basic-default-name" />
                            </div>
                              <p></p>
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
            ...
            <div class="row">                 
                   <div class="col-md-12">
                        <div class="card mb-4">
                            <h5 class="card-header">Liste Meuble</h5>
                              ...
                              <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                  ...
                                  <tr>                                    
                                    ...
                                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><% out.print(meuble.get(i).getMeuble()); %></strong></td>
